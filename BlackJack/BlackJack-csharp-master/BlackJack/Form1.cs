    ...
    public partial class Form_jogo : Form
    {
        ...
        public void resultado()
        {
            ...
            if (pontos_A > pontos_B && pontos_A <= 21)
                lbl_Resultado.Text = nomej1 + "GANHOU 🏆";
            else
                if (pontos_A < pontos_B && pontos_B <= 21)
                lbl_Resultado.Text = nomej2 + "GANHOU 🏆";
            else
        ...
        private void nomej1_TextChanged(object sender, EventArgs e)
        {
            int nomej1;

            nomej1 = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine(nomej1);
        }

        private void nomej2_TextChanged(object sender, EventArgs e)
        {
            int nomej2;

            nomej2 = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine(nomej2);
        }
